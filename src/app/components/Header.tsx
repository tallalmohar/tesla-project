...
export default function Header() {
  ...
  const [openDropdown, setOpenDropdown] = useState<
    null | "vehicle" | "energy" | "charging" | "discover" | "shop"
  >(null);
  ...
  const chargingLinks = [
    {
      name: "Scedule a Consultation",
      src: "https://www.tesla.com/solar-virtual-consultations",
    },
    { name: "Why Solar", src: "https://www.tesla.com/why-solar" },
    {
      name: "Incentives",
      src: "https://www.tesla.com/support/energy/powerwall/learn/incentives",
    },
    { name: "Support", src: "https://www.tesla.com/support/energy" },
    {
      name: "Partener with Tesla",
      src: "https://www.tesla.com/partner-with-tesla",
    },
  ...
  const energyLink = [
    { name: "Help Me Charge", src: "https://www.tesla.com/help-me-charge" },
    {
      ...
      src: "https://www.tesla.com/charging-calculator",
    },
    { name: "Charging with NACS", src: "https://www.tesla.com/NACS" },
    {
      name: "Supercharger Voting",
      src: "https://www.tesla.com/supercharger-voting/overview",
    },
    {
      name: "Host a Supercharger",
      src: "https://www.tesla.com/host-a-supercharger",
    },
    {
      name: "Commercial Charging",
      src: "https://www.tesla.com/commercial-charging",
    },
    {
      name: "Host Wall Connectors",
      src: "https://www.tesla.com/charging-partners",
    },
  ];
  ...
  const discover3 = [
    ...
    { name: "Careers", src: "https://www.tesla.com/careers" },
    {
      ...
      src: "https://ir.tesla.com/#quarterly-disclosure",
    },
  ];
  const discover2 = [
    {
      name: "Find Us",
      src: "https://www.tesla.com/findus?bounds=52.70122031185168%2C-64.3473379%2C21.542305545773416%2C-148.7223379",
    },
    {
      name: "Find a Collision Center",
      src: "https://www.tesla.com/support/collision-support",
    },
    {
      name: "Find a Collision Installer",
      src: "https://www.tesla.com/support/certified-installers",
    },
  ];
  ...
  return (
    <>
      <div
        className="flex justify-between items-center h-15 pr-10"
        role="navigation"
      ...
      >
        ...
        />
        <div className="flex" role="menubar" aria-label="Main menu">
          <button
            className="px-3  hover:bg-gray-200 hover:cursor-pointer rounded transition"
            onMouseEnter={() => setOpenDropdown("vehicle")}
            aria-label="Open Vehicles menu"
            role="menuitem"
          >
            Vehicles
          </button>
        ...
        <div className="flex gap-2" aria-label="Account and support actions">
          <a href="https://www.tesla.com/support">
            <button
              className="px-1 py-1  hover:bg-gray-200 hover:cursor-pointer rounded transition"
              aria-label="Support"
            >
              <Image
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center flex-col">
                        ...
                        <div className="flex gap-3 text-xs text-gray-500">
                          ...
                          <a
                            className="underline"
                            href="https://www.tesla.com/cybertruck/design#overview"
                          >
                            Order
                          </a>
                        </div>
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center flex-col">
                        ...
                        <div className="flex gap-3 text-xs text-gray-500">
                          <a
                            className="underline"
                            href="https://www.tesla.com/inventory/new/m3?PaymentType=cash"
                          >
                            Learn
                          </a>{" "}
                          <a
                            className="underline"
                            href="https://www.tesla.com/inventory/used/my?PaymentType=cash"
                          >
                            Order
                          </a>
                        </div>
                  ...
                  <div className="ml-10">
                    <ul>
                      {vehicleLinks.map((item) => (
                        <li
                          key={item.name}
                          className="pt-3 hover:underline font-bold text-sm"
                        >
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center flex-col">
                        ...
                        <div className="flex gap-3 text-xs text-gray-500">
                          ...
                          <a
                            className="underline"
                            href="https://www.tesla.com/energy/design?poi=solarpanels"
                          >
                            Order
                          </a>
                        </div>
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center flex-col">
                        ...
                        <div className="flex gap-3 text-xs text-gray-500">
                          ...
                          <a
                            className="underline"
                            href="https://www.tesla.com/energy/design?poi=solarroof"
                          >
                            Order
                          </a>
                        </div>
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center flex-col">
                        ...
                        <div className="flex gap-3 text-xs text-gray-500">
                          <a
                            className="underline"
                            href="https://www.tesla.com/megapack"
                          >
                            Learn
                          </a>
                        </div>
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center flex-col">
                        ...
                        <div className="flex gap-3 text-xs text-gray-500">
                          <a
                            className="underline"
                            href="https://www.tesla.com/home-charging"
                          >
                            Learn
                          </a>{" "}
                          <a
                            className="underline"
                            href="https://shop.tesla.com/category/charging#charging.at-home"
                          >
                            Order
                          </a>
                        </div>
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center flex-col">
                        ...
                        <div className="flex gap-3 text-xs text-gray-500">
                          ...
                          <a
                            className="underline"
                            href="https://www.tesla.com/findus?bounds=52.70122031185168%2C-64.3473379%2C21.542305545773416%2C-148.7223379"
                          >
                            Find
                          </a>
                        </div>
                  ...
                  <div className="">
                    ...
                    <div className="flex items-center flex-col">
                      ...
                      <div className="flex gap-3 text-xs text-gray-500">
                        <a
                          className="underline"
                          href="shop.tesla.com/category/charging"
                        >
                          Learn
                        </a>
                      </div>
